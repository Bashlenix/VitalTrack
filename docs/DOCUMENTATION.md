...
![Figure 1 - registration page.](/images/docs/01_registration_page.png "Figure 1 - registration page.")
...
![Figure 2 - registration success page.](/images/docs/02_registration_success_page.png "Figure 1 - registration success page.")

### 3.2 Login

Figure 3 shows the login page. Doctors can log in using either their username or email address along with their password.

![Figure 3 - login page.](/images/docs/03_login_page.png "Figure 3 - login page.")
...
![Figure 4 - main dashboard.](/images/docs/04_main_dashboard.png "Figure 4 - main dashboard.")
...
![Figure 5 - patients list page.](/images/docs/05_patients_list_page.png "Figure 5 - patients list page.")
...
![Figure 6 - patients list page.](/images/docs/06_add_patient_form.png "Figure 6 - patients list page.")
