...
class Patient(db.Model):
    ...
    gender = db.Column(Enum(GenderEnum, name="gender_enum"), nullable=False)
...
class Appointment(db.Model):
    ...
    appointment_type = db.Column(
        Enum(AppointmentTypeEnum, name="appointment_type_enum"), nullable=True
    )
...
class SocialHistory(db.Model):
    ...
    smoking_status = db.Column(db.Boolean, nullable=False, default=False)
    alcohol_use = db.Column(
        Enum(AlcoholConsumptionEnum, name="alcohol_consumption_enum"), nullable=True
    )
    drug_use = db.Column(Enum(DrugUseEnum, name="drug_use_enum"), nullable=True)
